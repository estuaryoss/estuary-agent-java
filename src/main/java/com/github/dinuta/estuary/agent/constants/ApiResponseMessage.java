...
public class ApiResponseMessage {
    ...
    static {
        ...
        message.put(ApiResponseCode.COMMAND_DETACHED_START_FAILURE.code, "Starting detached command with id %s failed");
        message.put(ApiResponseCode.COMMAND_DETACHED_STOP_FAILURE.code, "Stopping running detached commands failed");
        message.put(ApiResponseCode.GET_FILE_FAILURE_IS_DIR.code, "Getting %s failed. It is a directory.code, not a file.");
        ...
        message.put(ApiResponseCode.GET_COMMAND_DETACHED_INFO_FAILURE.code, "Failed to get detached command info.");
        ...
        message.put(ApiResponseCode.HTTP_HEADER_NOT_PROVIDED.code, "Http header value not provided.code, '%s'");
        ...
        message.put(ApiResponseCode.INVALID_YAML_CONFIG.code, "Invalid yaml config");
