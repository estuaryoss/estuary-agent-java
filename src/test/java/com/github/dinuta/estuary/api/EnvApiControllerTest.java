...
import com.github.dinuta.estuary.api.models.ApiResponseMap;
...
public class EnvApiControllerTest {
    ...
    public void whenCallingGetThenInformationIsRetrivedOk() {
        ...
        assertThat(body.getMessage()).isEqualTo(com.github.dinuta.estuary.constants.ApiResponseMessage.getMessage(ApiResponseConstants.SUCCESS));
