...
public class ApiResponseMessage {
    ...
    static {
        ...
        message.put(ApiResponseConstants.COMMAND_DETACHED_START_FAILURE, "Starting detached command with id %s failed");
        message.put(ApiResponseConstants.COMMAND_DETACHED_STOP_FAILURE, "Stopping running detached commands failed");
        message.put(ApiResponseConstants.GET_FILE_FAILURE_IS_DIR, "Getting %s failed. It is a directory, not a file.");
        ...
        message.put(ApiResponseConstants.GET_COMMAND_DETACHED_INFO_FAILURE, "Failed to get detached command info.");
