...
public class ApiResponseMessage {
    ...
    static {
        ...
        message.put(ApiResponseConstants.GET_FILE_FAILURE, "Getting file or folder from the estuary testrunner service container failed");
        ...
        message.put(ApiResponseConstants.GET_FILE_FAILURE_IS_DIR, "Getting %s from the container %s failed. It is a directory, not a file.");
        message.put(ApiResponseConstants.GET_ENV_VAR_FAILURE, "Getting env var %s from the container failed.");
        ...
        message.put(ApiResponseConstants.UPLOAD_TEST_CONFIG_FAILURE, "Failed to upload test configuration.");
