...
public interface FolderApi {
    ...
    @ApiOperation(value = "Gets the folder as zip archive. Useful to get test results folder", nickname = "folderGet", notes = "", response = ApiResponse.class, tags = {"estuary-testrunner",})
    @ApiResponses(value = {
