...
public class FolderApiControllerTest {
    ...
    public void whenFolderPathIsMissingThenApiReturnsError() {
        ...
        assertThat(body.getMessage()).isEqualTo(
                String.format(com.github.dinuta.estuary.constants.ApiResponseMessage.getMessage(ApiResponseConstants.HTTP_HEADER_NOT_PROVIDED), HeaderConstants.FOLDER_PATH));
