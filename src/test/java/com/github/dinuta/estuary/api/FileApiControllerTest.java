...
import com.github.dinuta.estuary.api.constants.HeaderConstants;
...
public class FileApiControllerTest {
    ...
    public void whenFilePathIsMissingThenApiReturnsError() {
        ...
        assertThat(body.getMessage()).isEqualTo(
                String.format(com.github.dinuta.estuary.constants.ApiResponseMessage.getMessage(ApiResponseConstants.HTTP_HEADER_NOT_PROVIDED), HeaderConstants.FILE_PATH));
    ...
    public void whenFilePathIsWrongThenApiReturnsError() {
        ...
        assertThat(body.getMessage()).isEqualTo(
                String.format(com.github.dinuta.estuary.constants.ApiResponseMessage.getMessage(ApiResponseConstants.GET_FILE_FAILURE)));
    ...
    public void whenUploadingFileAndFilePathIsWrongThenApiReturnsError() {
        ...
        assertThat(body.getMessage()).isEqualTo(
                String.format(com.github.dinuta.estuary.constants.ApiResponseMessage.getMessage(ApiResponseConstants.UPLOAD_FILE_FAILURE)));
        assertThat(body.getDescription()).contains("Exception");
        assertThat(body.getName()).isEqualTo(About.getAppName());
        assertThat(body.getVersion()).isEqualTo(About.getVersion());
        assertThat(body.getTime()).isBefore(LocalDateTime.now());
    ...
    public void whenUploadingFileAndFilePathIsCorrectThenApiReturnsSuccess() {
        ...
        assertThat(body.getMessage()).isEqualTo(
                String.format(com.github.dinuta.estuary.constants.ApiResponseMessage.getMessage(ApiResponseConstants.SUCCESS)));
        assertThat(body.getDescription()).isEqualTo(
